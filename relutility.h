...
double interp_lin_3d(double v1, double v2, double v3, double v4, double v5, double v6, double v7, double v8, double d[]);  // non-Kerr mods
...
int is_xill_model2(int model_type);  // non-Kerr modification
